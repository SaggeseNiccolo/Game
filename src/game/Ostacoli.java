...
public class Ostacoli extends Component {
    ...
    public boolean checkCollisionTop(Personaggio player) {
        ...
        // If the player's top edge is at the same y-coordinate as the obstacle's bottom
        // edge,
        // and the x-coordinates of the player and the obstacle overlap, there is a
        // collision
    ...
    public boolean checkCollisionRight(Personaggio player) {
        ...
        // If the player's right edge is at the same x-coordinate as the obstacle's left
        // edge,
        // and the y-coordinates of the player and the obstacle overlap, there is a
        // collision
    ...
    public boolean checkCollisionLeft(Personaggio player) {
        ...
        // If the player's left edge is at the same x-coordinate as the obstacle's right
        // edge,
        // and the y-coordinates of the player and the obstacle overlap, there is a
        // collision
    ...
    public boolean checkCollisionBottom(Personaggio player) {
        ...
        // If the player's bottom edge is at the same y-coordinate as the obstacle's top
        // edge,
        // and the x-coordinates of the player and the obstacle overlap, there is a
        // collision
